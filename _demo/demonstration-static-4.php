...
/**
 * Required classes (files) for static demonstration #4
 */
...
/**
 * generate map from input "data/map4.json"
 */
$map->generate('data/map4.json');


/**
 * !!!! IMPORTANT !!! => we don't need to wire anything! everything comes out of the box
 */
